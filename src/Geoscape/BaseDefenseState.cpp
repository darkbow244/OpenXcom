...
BaseDefenseState::BaseDefenseState(Game *game, Base *base, Ufo *ufo, GeoscapeState *state) : State(game), _state(state)
{
	...
	_btnOk->onKeyboardPress((ActionHandler)&BaseDefenseState::btnOkClick, (SDL_Keycode)Options::getInt("keyOk"));
	_btnOk->onKeyboardPress((ActionHandler)&BaseDefenseState::btnOkClick, (SDL_Keycode)Options::getInt("keyCancel"));
