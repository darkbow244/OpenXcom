...
ResearchRequiredState::ResearchRequiredState(Game *game, RuleItem *item) : State(game)
{
	...
	_btnOk->onKeyboardPress((ActionHandler)&ResearchRequiredState::btnOkClick, (SDL_Keycode)Options::getInt("keyCancel"));
	_btnOk->onKeyboardPress((ActionHandler)&ResearchRequiredState::btnOkClick, (SDL_Keycode)Options::getInt("keyOk"));
