...
CraftPatrolState::CraftPatrolState(Game *game, Craft *craft, Globe *globe) : State(game), _craft(craft), _globe(globe)
{
	...
	_btnOk->onKeyboardPress((ActionHandler)&CraftPatrolState::btnOkClick, (SDL_Keycode)Options::getInt("keyCancel"));
	...
	_btnRedirect->onKeyboardPress((ActionHandler)&CraftPatrolState::btnRedirectClick, (SDL_Keycode)Options::getInt("keyOk"));
