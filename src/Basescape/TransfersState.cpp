...
TransfersState::TransfersState(Game *game, Base *base) : State(game), _base(base)
{
	...
	_btnOk->onKeyboardPress((ActionHandler)&TransfersState::btnOkClick, (SDL_Keycode)Options::getInt("keyOk"));
	_btnOk->onKeyboardPress((ActionHandler)&TransfersState::btnOkClick, (SDL_Keycode)Options::getInt("keyCancel"));
