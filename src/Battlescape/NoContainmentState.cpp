...
NoContainmentState::NoContainmentState(Game *game) : State(game)
{
	...
	_btnOk->onKeyboardPress((ActionHandler)&NoContainmentState::btnOkClick, (SDL_Keycode)Options::getInt("keyOk"));
	_btnOk->onKeyboardPress((ActionHandler)&NoContainmentState::btnOkClick, (SDL_Keycode)Options::getInt("keyCancel"));
