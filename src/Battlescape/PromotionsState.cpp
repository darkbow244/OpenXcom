...
PromotionsState::PromotionsState(Game *game) : State(game)
{
	...
	_btnOk->onKeyboardPress((ActionHandler)&PromotionsState::btnOkClick, (SDL_Keycode)Options::getInt("keyOk"));
	_btnOk->onKeyboardPress((ActionHandler)&PromotionsState::btnOkClick, (SDL_Keycode)Options::getInt("keyCancel"));
