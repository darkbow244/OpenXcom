...
BriefingState::BriefingState(Game *game, Craft *craft, Base *base) : State(game)
{
	...
	_btnOk->onKeyboardPress((ActionHandler)&BriefingState::btnOkClick, (SDL_Keycode)Options::getInt("keyOk"));
	_btnOk->onKeyboardPress((ActionHandler)&BriefingState::btnOkClick, (SDL_Keycode)Options::getInt("keyCancel"));
