...
CannotReequipState::CannotReequipState(Game *game, std::vector<ReequipStat> missingItems) : State(game)
{
	...
	_btnOk->onKeyboardPress((ActionHandler)&CannotReequipState::btnOkClick, (SDL_Keycode)Options::getInt("keyOk"));
	_btnOk->onKeyboardPress((ActionHandler)&CannotReequipState::btnOkClick, (SDL_Keycode)Options::getInt("keyCancel"));
