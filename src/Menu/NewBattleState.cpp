...
NewBattleState::NewBattleState(Game *game) : State(game), _craft(0)
{
	...
	_btnOk->onKeyboardPress((ActionHandler)&NewBattleState::btnOkClick, (SDL_Keycode)Options::getInt("keyOk"));

	_btnCancel->setColor(Palette::blockOffset(8)+5);
	_btnCancel->setText(tr("STR_CANCEL_UC"));
	_btnCancel->onMouseClick((ActionHandler)&NewBattleState::btnCancelClick);
	_btnCancel->onKeyboardPress((ActionHandler)&NewBattleState::btnCancelClick, (SDL_Keycode)Options::getInt("keyCancel"));
