...
void ErrorMessageState::create(const std::string &str, const std::wstring &wstr, Uint8 color, std::string bg, Uint8 bgColor)
{
	...
	_btnOk->onKeyboardPress((ActionHandler)&ErrorMessageState::btnOkClick, (SDL_Keycode)Options::getInt("keyOk"));
	_btnOk->onKeyboardPress((ActionHandler)&ErrorMessageState::btnOkClick, (SDL_Keycode)Options::getInt("keyCancel"));
